    ...
    <>
      {meteors.map((el, idx) => (
        <span
          key={"meteor" + idx}
          className={cn(
            "animate-meteor-effect absolute top-1/2 left-1/2 h-0.5 w-0.5 rounded-[9999px] bg-muted-foreground shadow-[0_0_0_1px_hsl(var(--muted-foreground)_/_0.1)] rotate-[215deg]",
