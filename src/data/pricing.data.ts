...
// FAQ data used by the pricing page for structured data (JSON-LD)
// Each FAQ entry contains localized question and answer fields used by
// `generateFAQPageSchema` in `src/utils/seo.ts`.
export const faqs = [
  {
    question: {
